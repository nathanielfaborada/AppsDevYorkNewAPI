...
const design_container = (data) => {
  ...
  if (data?.results) {
    ...
    DesignSection.innerHTML = '<p>No music data available</p>';
  }
};
...
const television_container = (data) => {
  ...
  if (data?.results) {
    ...
    TelevisionSection.innerHTML = '<p>No music data available</p>';
  }
};
...
const movies_container = (data) => {
  ...
  if (data?.results) {
    ...
    MoviesSection.innerHTML = '<p>No music data available</p>';
  }
};
