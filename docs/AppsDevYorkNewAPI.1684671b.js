...
async function fetchArticles() {
    try {
        ...
        const validArticles = data.results.filter((article)=>{
            return article.abstract && article.abstract.trim() !== '' || article.url && article.url !== "null";
        });
      ...
      `;
            ...
            if (article.url && article.url !== "null") cardHTML += `<a href="${article.url}" target="_blank" class="text-yellow-400 hover:underline">Read more</a>`;
...
//# sourceMappingURL=AppsDevYorkNewAPI.1684671b.js.map
